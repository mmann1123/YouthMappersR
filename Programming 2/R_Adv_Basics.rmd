...
You can extend the capabilities of R by installing and importing packages written by folks like you. For a list of packages relevant to spatial data go to  [http://cran.r-project.org/web/views/Spatial.html](http://cran.r-project.org/web/views/Spatial.html)
